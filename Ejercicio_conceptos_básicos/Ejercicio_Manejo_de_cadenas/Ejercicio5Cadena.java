...
public class Ejercicio5Cadena {
    public static void main(String[] args) {
        ...
        System.out.println("Introduce al texto a buscar:");
        String textoBuscado = sc.nextLine();

        int posicionEcontrada = cadena.indexOf(textoBuscado);

        System.out.println(cadena.length());
        System.out.println((posicionEcontrada >= 0) ? "Se encuentra en la posición: " + posicionEcontrada : "No está en el texto");
